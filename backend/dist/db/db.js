...
const tempDbReset = process.env.DB_TEMP_RESET === '1' || String(process.env.DB_TEMP_RESET || '').toLowerCase() === 'true';
const referralHardReset = !tempDbReset &&
...
async function createTables() {
    ...
    try {
        ...
        if (tempDbReset) {
            logger.warn('DB_TEMP_RESET: dropping commission_transactions, binary_carry, referral_closure, referral_users, orders, users');
