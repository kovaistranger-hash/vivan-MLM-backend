...
export const checkoutSchema = z.object({
    ...
    customerGstin: z.preprocess((val) => (typeof val === 'string' && val.trim() === '' ? undefined : val), z.string().trim().max(20).optional()),
    walletAmount: z.preprocess((v) => (v === '' || v === undefined || v === null ? undefined : Number(v)), z.number().nonnegative().max(1_000_000_000).optional())
});
