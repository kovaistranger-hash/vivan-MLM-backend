...
export async function bankAccountsUpdate(req, res) {
...
export async function bankAccountsDelete(req, res) {
    const id = Number(req.params.id);
    if (!Number.isFinite(id))
        throw new ApiError(400, 'Invalid id');
